package com.ablec.myarchitecture.logic.system.binder
...
import com.ablec.myarchitecture.android.fileDescriptor
...
//            LogUtils.d(aidlData.toString())
    ...
    private fun bindToolbar() {
        val toolbar = parentFragment?.view?.findViewById<MaterialToolbar>(R.id.toolbar) ?: return
        (requireActivity() as? AppCompatActivity)?.supportActionBar?.setDisplayHomeAsUpEnabled(true)
        toolbar.title = "Binder"
